...
class MainActivity : AbstractWearActivity(), View.OnClickListener {
            ...
            Constants.REQ_CODE_CONTACT -> if (resultCode == Activity.RESULT_OK && data != null) {
                ...
                if (address != "-1") {
                    ...
                    startActivityForResult(
                        Intent(RemoteInputIntent.ACTION_REMOTE_INPUT).apply { putExtra(RemoteInputIntent.EXTRA_REMOTE_INPUTS, arrayOf(input.build())) },
    ...
    override fun onClick(view: View?) {
        startActivityForResult(Intent(this, ContactPickerActivity::class.java), Constants.REQ_CODE_CONTACT)
    }
